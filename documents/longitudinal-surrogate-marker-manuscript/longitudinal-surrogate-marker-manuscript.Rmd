...
We aim to measure the surrogate value of $\bX$ comparing $\Delta$ to the residual treatment effect that would be observed if the $\bX$ was distributed the same in both groups. In the context of a scalar $X$, the residual treatment effect can be defined as
